...
# give a third argument with list of bam files for call_lofreq with bed to make it use the same bam file
#--------------
...
bash $SCRIPTS/call_lofreq_withbed.sh ./all_samp_bcf.bed $2 $3
