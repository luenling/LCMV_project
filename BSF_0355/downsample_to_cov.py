...
The algorithm is quite inefficient and needs ridiculous amounts of memory ( around 8.5 GB per 32 Mio reads), as it stores all read names in a hash and a list.
